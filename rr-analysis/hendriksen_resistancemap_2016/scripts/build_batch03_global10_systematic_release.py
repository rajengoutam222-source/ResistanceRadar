...
TARGET = BASE / "dataset_inputs_batch03_global10"
BUILD = BASE / ".dataset_inputs_batch03_global10.building"

MEGA_STAGE = BASE / "stage3_5_megahit_PRJEB13831_batch03_global10"

MEGA_SHEET = (
    MEGA_STAGE
    / "samplesheets"
    / "PRJEB13831_batch03_global10_megahit_samples.tsv"
)

FASTP_ROOT = BASE / "fastp" / "PRJEB13831_batch03_global10"

BOWTIE2_ROOT = (
    BASE
    / "results"
    / "bowtie2_PRJEB13831_batch03_global10"
)

RGI_MAIN_ROOT = (
    BASE
    / "stage3_5_rgi_main_contigs_PRJEB13831_batch03_global10"
    / "results"
)

GENOMAD_ROOT = (
    BASE
    / "stage3_5_genomad_PRJEB13831_batch03_global10"
    / "results"
)

DIAMOND_ROOT = (
    BASE
    / "stage3_4c_diamond_card_PRJEB13831_batch03_global10"
    / "results_cleanfasta"
)

RGI_BWT_ROOT_CANDIDATES = [
    BASE / "rgi_bwt_PRJEB13831_batch03_global10",
]
...
ARG_MOBILITY_ROOT = (
    BASE
    / "stage3_5_arg_mobility_overlap_PRJEB13831_batch03_global10"
)

ARG_MOBILITY_PREFIX = "rm2016_batch03_global10"
...
for index, sample in enumerate(samples, start=1):
    ...
    bowtie_source = (
        BOWTIE2_ROOT
        / sample
        / f"{sample}.bowtie2_alignment.log"
    )
    ...
    manifest_rows.append(
        {
            "sample_id": sample,
            "cohort": "RM2016_batch03_global10",
            "FASTP": "PASS",
            "Bowtie2": "PASS",
            "CARD_RGI_BWT": "PASS",
            "DIAMOND_CARD": "PASS",
...
manifest_relative = (
    Path("metadata")
    / "batch03_global10_sample_manifest.tsv"
)
...
readme = f"""# ResistanceRadar RM2016 Batch03 global10 compact dataset inputs
