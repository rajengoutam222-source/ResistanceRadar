...
TARGET = BASE / "dataset_inputs_batch02_10countries_plus_USA_alt11"
BUILD = BASE / ".dataset_inputs_batch02_10countries_plus_USA_alt11.building"

MEGA_STAGE = BASE / "stage3_5_megahit_batch02_10countries_plus_USA_alt11"

MEGA_SHEET = (
    MEGA_STAGE
    / "samplesheets"
    / "batch02_10countries_plus_USA_alt11_megahit_samples.tsv"
)

FASTP_ROOT = BASE / "fastp" / "batch02_10countries_plus_USA_alt11"

BOWTIE2_ROOT = (
    BASE
    / "results"
    / "bowtie2_batch02_10countries_plus_USA_alt11"
)

RGI_MAIN_ROOT = (
    BASE
    / "stage3_5_rgi_main_contigs_batch02_10countries_plus_USA_alt11"
    / "results"
)

GENOMAD_ROOT = (
    BASE
    / "stage3_5_genomad_batch02_10countries_plus_USA_alt11"
    / "results"
)

DIAMOND_ROOT = (
    BASE
    / "stage3_4c_diamond_card_batch02_10countries_plus_USA_alt11"
    / "results_cleanfasta"
)

RGI_BWT_ROOT_CANDIDATES = [
    BASE / "results" / "rgi_bwt_batch02_10countries_plus_USA_alt11",
    BASE / "rgi_bwt_batch02_10countries_plus_USA_alt11",
    BASE / "stage3_4b_rgi_bwt_batch02_10countries_plus_USA_alt11",
]
...
for index, sample in enumerate(samples, start=1):
    ...
    genomad_source = (
        GENOMAD_ROOT
        / sample
        / f"{sample}.contigs_aggregated_classification"
        / f"{sample}.contigs_aggregated_classification.tsv"
    )
    ...
    manifest_rows.append(
        {
            "sample_id": sample,
            "cohort": "RM2016_batch02_10countries_plus_USA_alt11",
            "FASTP": "PASS",
            "Bowtie2": "PASS",
            "CARD_RGI_BWT": "PASS",
            "DIAMOND_CARD": "PASS",
...
add_provenance(
    manifest_relative,
    [MEGA_SHEET],
    "Standardized 11-sample release manifest generated",
)


readme = f"""# ResistanceRadar RM2016 Batch02 compact dataset inputs
