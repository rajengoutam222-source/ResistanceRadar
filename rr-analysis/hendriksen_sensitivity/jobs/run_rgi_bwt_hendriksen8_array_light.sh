#!/bin/bash
#BSUB -J "HENDRIKSEN8_RGI_BWT_LIGHT[1-8]%2"
#BSUB -q single_chassis
#BSUB -n 4
#BSUB -R "span[hosts=1]"
#BSUB -R "rusage[mem=48GB]"
#BSUB -W 72:00
#BSUB -o rr-analysis/hendriksen_sensitivity/rgi_bwt/logs/HENDRIKSEN8_RGI_BWT_LIGHT_%I_%J.out
#BSUB -e rr-analysis/hendriksen_sensitivity/rgi_bwt/logs/HENDRIKSEN8_RGI_BWT_LIGHT_%I_%J.err
