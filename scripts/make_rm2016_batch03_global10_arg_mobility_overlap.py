...
RGI_DIR = ROOT / "stage3_5_rgi_main_contigs_PRJEB13831_batch03_global10/results"
GENOMAD_DIR = ROOT / "stage3_5_genomad_PRJEB13831_batch03_global10"

OUTDIR = ROOT / "stage3_5_arg_mobility_overlap_PRJEB13831_batch03_global10"
OUTDIR.mkdir(parents=True, exist_ok=True)

OUT_ALL = OUTDIR / "rm2016_batch03_global10_ARG_mobility_overlap.tsv"
OUT_ALL_GZ = OUTDIR / "rm2016_batch03_global10_ARG_mobility_overlap.tsv.gz"
OUT_STRICT = OUTDIR / "rm2016_batch03_global10_ARG_mobility_overlap_strict_perfect.tsv"
OUT_SUMMARY = OUTDIR / "rm2016_batch03_global10_ARG_mobility_sample_summary.tsv"
OUT_SUMMARY_STRICT = OUTDIR / "rm2016_batch03_global10_ARG_mobility_sample_summary_strict_perfect.tsv"
OUT_DRUG = OUTDIR / "rm2016_batch03_global10_ARG_mobility_drug_class_summary.tsv"
OUT_CKPT = ROOT / "checkpoints/RM2016_BATCH03_GLOBAL10_ARG_MOBILITY_OVERLAP_COMPLETE.txt"
